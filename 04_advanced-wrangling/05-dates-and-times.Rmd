...
We have described three main types of vectors: numeric, character, and logical. In data science projects we very often encounter variables that are dates. Although we can represent a date with a string, for example, `October 28, 2024`, once we pick a reference day, referred to as the _epoch_, they can be converted to numbers. Computer languages usually use [January 1, 1970 as the epoch](https://www.quora.com/Why-does-epoch-time-start-with-January-1-1970). So, October 28, 2024 is day 20,025. 
...
### Question 2
Create a data frame with columns `clean_dates`, `month`, `day` and `year` from the string of dates in Question 1.
