...
- Cole Nussbaumer Knaflic (2015) [Storytelling with Data](https://www.storytellingwithdata.com/books) 
- Rob Kabacoff (2018) [Data Visualization with R](https://rkabacoff.github.io/datavis/)


If we have time, we will cover the basics of interactive graphics later in this course. If you want to check out interactive graphs now, below are some useful resources for learning more.
...
## A first introduction to `ggplot2`
 ...
 We will be using the [`ggplot2`](https://ggplot2.tidyverse.org/) package. We can load it, along with `dplyr`, as part of the tidyverse:
